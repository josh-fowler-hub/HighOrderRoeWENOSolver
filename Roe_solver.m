function [Fip12,Fim12] = Roe_solver(U,URi,ULi,URim1,ULim1,g, CD_Term_Order)
...
[Pstar_root,error,Iter] = Newton_Raphson_P(Pstar0,PL,PR,rhoL,rhoR,g,du,iter_limit,tol);
method = 1;

if error > tol
    [Pstar_root, error,Iter] = Bisection_P(PL, PR, uL, uR, rhoL, rhoR, g, du, iter_limit, tol);
    method = 2;
end
if error > tol
    [Pstar_root,error,Iter] = Newton_Raphson_P(Pstar_root,PL,PR,rhoL,rhoR,g,du,iter_limit,tol);
    method = 1;
end
% if method == 1
...
function [Pstar_root, error,Iter] = Bisection_P(PL, PR, uL, uR, rhoL, rhoR, g, du, Iter_Limit, tol)
...
function [Pstar_root,error,Iter] = Newton_Raphson_P(Pstar0,PL,PR,rhoL,rhoR,g,du,iter_limit,tol)
error = 2*tol;
Iter = 0;
Pstar = Pstar0;
