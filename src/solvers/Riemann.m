...
function [Pstar_root, error] = bisectionP(PL, PR, uL, uR, rhoL, rhoR, g, du, Iter_Limit, tol)
Pstar0 = Pguess(0, PL, PR, uL, uR, rhoL, rhoR, g, du);
Pstar1 = Pguess(1, PL, PR, uL, uR, rhoL, rhoR, g, du);
Pstar2 = Pguess(2, PL, PR, uL, uR, rhoL, rhoR, g, du);
Pstar3 = Pguess(3, PL, PR, uL, uR, rhoL, rhoR, g, du);
...
function [Pstar_root,error] = newtonRaphsonP(Pstar0,PL,PR,rhoL,rhoR,g,du,iter_limit,tol)
error = 2*tol;
Iter = 0;
Pstar = Pstar0;
