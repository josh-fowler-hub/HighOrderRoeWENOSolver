...
% Extract stencil points and corresponding primitive variables
Uim3 = U(:,1:end-6);
rhoim3 = rho(:,1:end-6);
uim3 = u(:,1:end-6);
Pim3 = P(:,1:end-6);
...
function [ustarL,ustarR,astarL,astarR] = adaptiveRiemannSolver(rhoLim1,rhoRi,uLim1,uRi,aLim1,aRi,PLim1,PRi,g) % Toro 9.5.2
